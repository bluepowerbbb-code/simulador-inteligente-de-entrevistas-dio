# simulador-inteligente-de-entrevistas-dio
Simulador estruturado de entrevistas técnicas para vagas de tecnologia, conduzido por IA com fluxo controlado de perguntas e geração de resumo analítico.
